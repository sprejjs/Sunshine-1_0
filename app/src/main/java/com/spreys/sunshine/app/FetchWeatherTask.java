...
public class FetchWeatherTask extends AsyncTask<String, Void, Void> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs.getString(
                ...
                mContext.getString(R.string.pref_general_units_metric_value));

        if (unitType.equals(mContext.getString(R.string.pref_general_units_imperial_value))) {
            high = (high * 1.8) + 32;
            low = (low * 1.8) + 32;
        } else if (!unitType.equals(mContext.getString(R.string.pref_general_units_metric_value))) {
